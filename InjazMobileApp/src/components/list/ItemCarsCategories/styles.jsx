...
const styles = StyleSheet.create({
  container: {
    height: Platform.OS === 'ios' ? moderateScale(460) : moderateScale(480),
  ...
  whatsImage: {
    ...
    marginRight: moderateScale(40), // Add margin to separate the image from text
  },
  buttonWhasAppText: {
    fontSize: textScale(12),
    color: colors.WHITE,
  ...
  bookNowButton: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    top: Platform.OS === 'ios' ? moderateScale(16) : moderateScale(10),
  },
  bookNowText: {
    color: colors.NAVY_BLUE,
    fontSize: textScale(12),
